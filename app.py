"""application entrypoint for the lightweight speech emotion recognition project.

loads the trained svm baseline and runs a quick sanity check on a random
sample from the test set. use this to verify the trained model loads and
predicts correctly before running the full evaluation pipeline.
